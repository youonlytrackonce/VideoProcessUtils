...
MOT20 = sum(histAR[2, :15000])
SOMPT22 = sum(histAR[0, :15000])
MOT17 = sum(histAR[1, :15000])
plt.bar(histAR_x[:15000], histAR[2, :15000]/MOT20, color='r', width=0.03, label='MOT20', alpha=0.4)
plt.bar(histAR_x[:15000], histAR[1, :15000]/MOT17, color='b', width=0.03, label='MOT17', alpha=0.8)
plt.bar(histAR_x[:15000], histAR[0, :15000]/SOMPT22, color='g', width=0.03, label='SOMPT22', alpha=0.6)
...
fig = plt.subplots(figsize=(10, 6))
MOT20 = sum(histHeight[2, :15000])
SOMPT22 = sum(histHeight[0, :15000])
MOT17 = sum(histHeight[1, :15000])
plt.bar(histH_x[:400], histHeight[2, :400]/MOT20, color='r', width=8, label='MOT20', alpha=0.4)
plt.bar(histH_x[:400], histHeight[1, :400]/MOT17, color='b', width=8, label='MOT17', alpha=0.8)
plt.bar(histH_x[:400], histHeight[0, :400]/SOMPT22, color='g', width=8, label='SOMPT22', alpha=0.6)
...
fig = plt.subplots(figsize=(10, 6))
MOT20 = sum(histDensity[2, :15000])
SOMPT22 = sum(histDensity[0, :15000])
MOT17 = sum(histDensity[1, :15000])
plt.bar(histD_x[:250], histDensity[2, :250]/MOT20, color='r', width=1.3, label='MOT20', alpha=0.4)
plt.bar(histD_x[:250], histDensity[1, :250]/MOT17, color='b', width=1.3, label='MOT17', alpha=0.8)
plt.bar(histD_x[:250], histDensity[0, :250]/SOMPT22, color='g', width=1.3, label='SOMPT22', alpha=0.6)
