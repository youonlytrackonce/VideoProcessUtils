...
DATA_PATH = '/home/fatih/disk1/trackeveryseason/images/'
...
if __name__ == '__main__':
  for split in SPLITS:
    data_path = DATA_PATH + split#(split if not HALF_VIDEO else 'train')
    ...
    for seq in sorted(seqs):
      ...
      for i in range(num_images):
        if (i < image_range[0] or i > image_range[1]):
          continue
        img = cv2.imread(img_path+'{:06d}.jpg'.format(i+1)) 
